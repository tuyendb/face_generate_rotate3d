...
from model.detect_swap.Deep3DFaceRecon_pytorch.util import util
import model.detect_swap.Deep3DFaceRecon_pytorch.models as models
import model.detect_swap.Deep3DFaceRecon_pytorch.data as data
...
class Option(metaclass=Singleton):
    ...
    """
    def __init__(self, cmd_line=None, cfg=Config()):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=int, default=self.cfg.gpu_id, help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default=self.cfg.rec_checkpoint_dir, help='models are saved here')
        ...
        parser.add_argument('--img_folder', '-if', type=str, default='/AIHCM/AI_Member/tuyennx/face_generate/face_render/images_test/new_test', help='folder for test images.')
        parser.add_argument('--img_path', '-ip', type=str, help='path of test image')
        parser.add_argument('--output_dir', type=str, default='/AIHCM/AI_Member/tuyennx/face_generate/face_render/output', help='folder for output test')
        parser.add_argument('--angle', type=np.int8, default=40, help='angle for range, exm[-40, 40, step = ..]')
        #for API
        parser.add_argument('--port', type=int, default=self.cfg.api_port, help='Selected port for api')
